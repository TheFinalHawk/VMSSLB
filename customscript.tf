...
resource "azurerm_storage_account" "tfvmstore4577687" {
...
resource "azurerm_virtual_machine_scale_set_extension" "scalesetextension" {  
  ...
  settings = <<SETTINGS
    {
        "fileUris": ["https://${azurerm_storage_account.tfvmstore4577687.name}.blob.core.windows.net/data/IIS_Config.ps1"],
